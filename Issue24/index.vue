...
import PingTe2Xiao from './pingTe2Xiao.vue'
import OverKill from './overKill.vue'
import MiddlesNumberRange from './middlesNumberRange.vue'
import HavenEarthZodiac from './havenEarthZodiac.vue'
import SumOddEven from './sumOddEven.vue'
import InvincibleEightTail from './invincibleEightTail.vue'
import DuplexFlatCode from './duplexFlatCode.vue'
import OneSentenceDecipher from './oneSentenceDecipher.vue'
